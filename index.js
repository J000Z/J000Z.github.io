...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 62576,
    DYNAMIC_BASE = 5305456,
    DYNAMICTOP_PTR = 61616;
...
var ASM_CONSTS = [function() {throw 'Canceled!'},
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=62560;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        if (typeof SharedArrayBuffer === 'undefined') return []; // No multithreading support, no-op.
        var pthreadMainJs = "index.worker.js";
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 61680, 4), 61680);
...
var proxiedFunctionTable = [null,_atexit,___syscall221,___syscall5,___syscall54,___syscall91,_tzset,_emscripten_set_canvas_element_size_main_thread,_fd_close,_fd_read,_fd_seek,_fd_write];
